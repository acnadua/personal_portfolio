        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">
              Passionate Mobile Developer & Data Engineer
            </h3>

            <p className="text-muted-foreground">
              Specializing in creating accessible, reliable, and user-friendly
              mobile applications using Flutter with 2 years of experience.
            </p>

            <p className="text-muted-foreground">
              I like making practical solutions to different problems, from
              simple to complex ones, and constantly learning and staying
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="/Nadua_Resume.pdf"
                download="Nadua_Resume.pdf"
                className={cn(
                  "px-6 py-2 rounded-full border-primary text-primary",
